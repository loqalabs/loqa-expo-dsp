 ...
 * ```
 */
export async function createVoiceAnalyzer(config) {
 ...
 * ```
 */
export async function analyzeClip(analyzer, audioBuffer) {
    ...
    try {
        ...
        const frames = nativeResult.frames.map((frame) => ({
 ...
 * ```
 */
export async function processBuffer(analyzer, audioBuffer) {
 ...
 * ```
 */
export async function resetVoiceAnalyzer(analyzer) {
 ...
 * ```
 */
export async function freeVoiceAnalyzer(analyzer) {
...
//# sourceMappingURL=voiceAnalyzer.js.map